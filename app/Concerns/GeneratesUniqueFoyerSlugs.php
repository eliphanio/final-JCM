...
trait GeneratesUniqueFoyerSlugs
{
    /**
     * Generate a unique slug for the foyer.
     */
    protected static function generateUniqueFoyerSlug(string $name, ?int $excludeId = null): string
    {
