...
use Database\Factories\FoyerInvitationFactory;
 ...
 */
#[Fillable(['foyer_id', 'email', 'role', 'invited_by', 'expires_at', 'accepted_at'])]
class FoyerInvitation extends Model
{
    /** @use HasFactory<FoyerInvitationFactory> */
    use HasFactory;
    ...
    protected static function boot(): void
    {
        ...
        static::creating(function (FoyerInvitation $invitation) {
    ...
    /**
     * Get the foyer that the invitation belongs to.
     *
