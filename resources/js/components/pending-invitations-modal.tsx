...
import FoyerInvitationController from '@/actions/App/Http/Controllers/Foyers/FoyerInvitationController';
...
export default function PendingInvitationsModal({
    ...
    const acceptInvitation = (invitation: DashboardInvitation) => {
        router.visit(FoyerInvitationController.accept(invitation), {
    ...
    const declineInvitation = (invitation: DashboardInvitation) => {
        router.visit(FoyerInvitationController.decline(invitation), {
            onStart: () => setProcessingCode(invitation.code),
            onFinish: () => setProcessingCode(null),
            onSuccess: () => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent data-test="pending-invitations-modal">
                <DialogHeader>
                    <DialogTitle>Pending foyer invitations</DialogTitle>
                    <DialogDescription>
