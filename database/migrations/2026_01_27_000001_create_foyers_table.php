...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('foyer_members', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['foyer_id', 'user_id']);
        });

        Schema::create('foyer_invitations', function (Blueprint $table) {
            $table->id();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('foyer_invitations');
        Schema::dropIfExists('foyer_members');
